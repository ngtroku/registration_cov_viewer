...
if __name__ == "__main__":
    file_name1 = "./data/000118.bin"
    csv_file_name2 = "./data/14_000101.bin"
    ...
    #source_raw_numpy, target_raw_numpy = factor.preprocess_manual(csv_file_name2, sampling_rate, rotation_x[0], rotation_y[0], rotation_z[0], noise_x[0], noise_y[0], file_format = "bin", lidar_model="VLP-16")
    #points_source2, importance_factor2 = factor.calc_factor(source_raw_numpy, target_raw_numpy)

    factor.postprocess([points_source1], [importance_factor1], ["./result_118.csv"])
